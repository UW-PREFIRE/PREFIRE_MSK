...
of the provenance of this package's products ('2B-MSK'); write to file.
...
Pypackages_to_query = ("PREFIRE_MSK", "PREFIRE_ML_MSK", "PREFIRE_PRD_GEN")
...
if __name__ == "__main__":
    ...
    arg_description = ("Determine product monikers and current (latest) git "
                       ...
                       "package's products ('2B-MSK'); write to file.")
